...
CREATE PROCEDURE CUR_PROC()
   BEGIN
      ...
      DECLARE Organization_ID, Government_approved INTEGER;
      DECLARE Organization_name, Location VARCHAR(20);
      DECLARE cur CURSOR FOR SELECT * FROM organization;
      DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = 1;
      DELETE from organization;
      OPEN cur;
      label: LOOP
      FETCH cur INTO Organization_ID,Organization_name, Location, Government_approved ;
      INSERT INTO organization VALUES(Organization_ID ,Organization_name, Location, Government_approved );
